...
\mbox{\label{group__vulkan_gac47c204c9c417fced07e25de8fce526a}} 
...
\doxysubsubsection{glfwGetRequiredInstanceExtensions()}
...
If Vulkan is not available on the machine, this function returns {\ttfamily N\+U\+LL} and generates a \doxyref{G\+L\+F\+W\+\_\+\+A\+P\+I\+\_\+\+U\+N\+A\+V\+A\+I\+L\+A\+B\+LE}{p.}{group__errors_ga56882b290db23261cc6c053c40c2d08e} error. Call \doxyref{glfw\+Vulkan\+Supported}{p.}{group__vulkan_ga72e7c3757d9ff2333181a5569bb7c403} to check whether Vulkan is available.
...
\end{DoxyReturn}
@errors Possible errors include \doxyref{G\+L\+F\+W\+\_\+\+N\+O\+T\+\_\+\+I\+N\+I\+T\+I\+A\+L\+I\+Z\+ED}{p.}{group__errors_ga2374ee02c177f12e1fa76ff3ed15e14a} and \doxyref{G\+L\+F\+W\+\_\+\+A\+P\+I\+\_\+\+U\+N\+A\+V\+A\+I\+L\+A\+B\+LE}{p.}{group__errors_ga56882b290db23261cc6c053c40c2d08e}.
...
\doxysubsubsection{glfwVulkanSupported()}
...
This function returns whether the Vulkan loader has been found. This check is performed by \doxyref{glfw\+Init}{p.}{group__init_gab41771f0215a2e0afb4cf1cf98082d40}.

The availability of a Vulkan loader does not by itself guarantee that window surface creation or even device creation is possible. Call \doxyref{glfw\+Get\+Required\+Instance\+Extensions}{p.}{group__vulkan_gac47c204c9c417fced07e25de8fce526a} to check whether the extensions necessary for Vulkan surface creation are available and glfw\+Get\+Physical\+Device\+Presentation\+Support to check whether a queue family of a physical device supports image presentation.
